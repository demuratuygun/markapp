import { IonCol, IonContent, IonFabButton, IonFooter, IonGrid, IonHeader, IonIcon, IonModal, IonPage, IonRow, IonTitle, IonToolbar } from '@ionic/react';
...
import { arrowBackOutline, closeOutline, playSkipForward, playSkipBack } from 'ionicons/icons';
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        <IonHeader className={calenderExpanded?'fixed-header':''}>
